          ...
          <div className="PublicBlogList__container">
            ...
            {filteredPosts.length === 0 ? (
              <div className="PublicBlogList__empty-state">
                <svg className="PublicBlogList__empty-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                {filteredPosts.map((post) => (
                  <div key={post._id} className="PublicBlogList__card">
                    <div className="PublicBlogList__card-header">
                      <span className={`PublicBlogList__category-badge PublicBlogList__category-badge--${post.category}`}>
                    ...
                    <div className="PublicBlogList__card-footer">
                      <Link to={`/blog/${post._id}`} className="PublicBlogList__read-more-btn">
                        Read full update
                        <svg className="PublicBlogList__arrow-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
